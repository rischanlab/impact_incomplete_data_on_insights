...
output_plot = 'RBO_impact_missing_data_5_insights'
...
df4 = pd.DataFrame([dfj400, dfj410, dfj420, dfj430, dfj440, dfj450, dfj460, dfj470, dfj470])#, dfj480])
...
ax.plot(mean1, lw = 1, color = '#000000', alpha = 1, label = 'Correlation', marker='x', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'Kurtosis', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'Skewness', marker='o', linestyle='--', linewidth=2, markersize=20)
